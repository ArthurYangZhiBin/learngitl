 ...
 *******************************************************************************/
package com.infor.scm.wms.util.validation.screen.vendor;
...
public class VendorScreenValidator extends OwnerScreenValidator{

	public VendorScreenValidator(WMSValidationContext context) {
		super(context);
	...
	public static String getErrorMessage(int errorCode, Locale locale, OwnerScreenVO ownerScreen){
		...
		case RULE_OWNER_MUST_BE_UNIQUE:
			param = new String[2];
			param[0] = MessageUtil.getResourceBundleMessage(ResourceConstants.KEY_SCREEN_VENDOR_FIELD_STORERKEY, locale);
			param[1] = ownerScreen.getStorerkey();
			return MessageUtil.getResourceBundleMessage(ResourceConstants.KEY_VENDOR_SCREEN_ERROR_DUPLICATE_VENDOR, locale, param);
