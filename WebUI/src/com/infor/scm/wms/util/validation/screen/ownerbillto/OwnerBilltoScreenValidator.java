 ...
 *******************************************************************************/
package com.infor.scm.wms.util.validation.screen.ownerbillto;
...
public class OwnerBilltoScreenValidator extends OwnerScreenValidator {
	
	public OwnerBilltoScreenValidator(WMSValidationContext context) {
		super(context);
	...
	public static String getErrorMessage(int errorCode, Locale locale, OwnerScreenVO ownerScreen){
		...
		case RULE_OWNER_MUST_BE_UNIQUE:
			param = new String[2];
			param[0] = MessageUtil.getResourceBundleMessage(ResourceConstants.KEY_SCREEN_OWNERBILLTO_FIELD_STORERKEY, locale);
			param[1] = ownerScreen.getStorerkey();
			return MessageUtil.getResourceBundleMessage(ResourceConstants.KEY_OWNERBILLTO_SCREEN_ERROR_DUPLICATE_OWNERBILLTO, locale, param);
