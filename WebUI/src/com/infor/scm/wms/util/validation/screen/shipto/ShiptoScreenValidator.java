 ...
 *******************************************************************************/
package com.infor.scm.wms.util.validation.screen.shipto;
...
public class ShiptoScreenValidator extends OwnerScreenValidator {
	
	public ShiptoScreenValidator(WMSValidationContext context) {
		super(context);
	...
	public static String getErrorMessage(int errorCode, Locale locale, OwnerScreenVO ownerScreen){
		...
		case RULE_OWNER_MUST_BE_UNIQUE:
			param = new String[2];
			param[0] = MessageUtil.getResourceBundleMessage(ResourceConstants.KEY_SCREEN_SHIPTO_FIELD_STORERKEY, locale);
			param[1] = ownerScreen.getStorerkey();
			return MessageUtil.getResourceBundleMessage(ResourceConstants.KEY_SHIPTO_SCREEN_ERROR_DUPLICATE_SHIPTO, locale, param);
