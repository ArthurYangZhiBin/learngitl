 ...
 *******************************************************************************/
package com.infor.scm.wms.util.validation.screen.freightbillto;
...
public class FreightBilltoScreenValidator extends OwnerScreenValidator {
	
	public FreightBilltoScreenValidator(WMSValidationContext context) {
		super(context);
	...
	public static String getErrorMessage(int errorCode, Locale locale, OwnerScreenVO ownerScreen){
		...
		case RULE_OWNER_MUST_BE_UNIQUE:
			param = new String[2];
			param[0] = MessageUtil.getResourceBundleMessage(ResourceConstants.KEY_SCREEN_FREIGHTBILLTO_FIELD_STORERKEY, locale);
			param[1] = ownerScreen.getStorerkey();
			return MessageUtil.getResourceBundleMessage(ResourceConstants.KEY_FREIGHTBILLTO_SCREEN_ERROR_DUPLICATE_FREIGHTBILLTO, locale, param);
