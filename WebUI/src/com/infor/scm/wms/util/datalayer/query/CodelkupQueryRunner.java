...
public class CodelkupQueryRunner extends BaseQueryRunner{
	public static DataLayerResultWrapper getCodelkupByListnameAndCode(String listname,String code, WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper codelkup = null;
		ArrayList parameters = new ArrayList();
		parameters.add(listname);		
		parameters.add(code);		
		codelkup = DataLayerInterface.getResult(DataLayerQueryList.QUERY_CODELKUP_BY_LISTNAME_CODE,parameters, context);
		return codelkup;
	}	
}