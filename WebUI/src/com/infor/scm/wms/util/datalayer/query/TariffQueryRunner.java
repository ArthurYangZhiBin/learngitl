...
public class TariffQueryRunner extends BaseQueryRunner{
	public static DataLayerResultWrapper getTariffByTariffKey(String tariffKey, WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper tariff = null;
		ArrayList parameters = new ArrayList();
		parameters.add(tariffKey);				
		tariff = DataLayerInterface.getResult(DataLayerQueryList.QUERY_TARIFF_BY_TARIFFEKY,parameters,context);
		return tariff;
	}	
}