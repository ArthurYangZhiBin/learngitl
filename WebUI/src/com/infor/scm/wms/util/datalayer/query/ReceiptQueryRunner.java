...
public class ReceiptQueryRunner extends BaseQueryRunner{

	public static DataLayerResultWrapper getReceiptByKey(String key, WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper receipt = null;
		ArrayList parameters = new ArrayList();
		parameters.add(key);
		receipt = DataLayerInterface.getResult(DataLayerQueryList.QUERY_RECEIPT_BY_RECEIPTKEY,parameters,context);
		return receipt;
	}
}
