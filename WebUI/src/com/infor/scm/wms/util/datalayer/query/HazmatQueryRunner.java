...
public class HazmatQueryRunner extends BaseQueryRunner{
	public static DataLayerResultWrapper getHazmatCodeByKey(String key, WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper storer = null;
		ArrayList parameters = new ArrayList();
		parameters.add(key);
		storer = DataLayerInterface.getResult(DataLayerQueryList.QUERY_HAZMAT_CODE_BY_HAZMATCODESKEY,parameters, context);
		return storer;
	}
