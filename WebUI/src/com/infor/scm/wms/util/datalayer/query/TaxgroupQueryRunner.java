...
public class TaxgroupQueryRunner extends BaseQueryRunner{
	public static DataLayerResultWrapper getTaxgroupByTaxgroupKey(String taxgroupkey, WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper taxgroup = null;
		ArrayList parameters = new ArrayList();
		parameters.add(taxgroupkey);				
		taxgroup = DataLayerInterface.getResult(DataLayerQueryList.QUERY_TAXGROUP_BY_TAXGROUPKEY,parameters, context);
		return taxgroup;
	}	
