...
public class CCSetupQueryRunner extends BaseQueryRunner{
	public static DataLayerResultWrapper getCCSetupByClassId(String classID, WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper ccSetup = null;
		ArrayList parameters = new ArrayList();
		parameters.add(classID);				
		ccSetup = DataLayerInterface.getResult(DataLayerQueryList.QUERY_CCSETUP_BY_CLASSID,parameters, context);
		return ccSetup;
	}	
}