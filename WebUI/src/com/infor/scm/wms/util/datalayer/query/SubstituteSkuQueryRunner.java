...
public class SubstituteSkuQueryRunner extends BaseQueryRunner{
	public static DataLayerResultWrapper getSubstituteSkuBySkuOwnerSubstituteSku(String sku,String owner,String substituteSku, WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper storer = null;
		ArrayList parameters = new ArrayList();
		parameters.add(sku);		
		parameters.add(owner);
		parameters.add(substituteSku);
		storer = DataLayerInterface.getResult(DataLayerQueryList.QUERY_SUBSTITUTESKU_BY_SKU_STORERKEY_SUBSTITUTESKU,parameters,context);
		return storer;
	}	
}