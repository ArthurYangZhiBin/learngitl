...
public class ReceiptdetailQueryRunner extends BaseQueryRunner{


	public static DataLayerResultWrapper getReceiptlinenumberByKey(String key, String receiptlinenumber,  WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper receiptdetail = null;
		ArrayList parameters = new ArrayList();
		parameters.add(key);
		receiptdetail = DataLayerInterface.getResult(DataLayerQueryList.QUERY_RECEIPTDETAIL_BY_RECEIPTKEY_AND_LINENUMBER,
				parameters,context);
