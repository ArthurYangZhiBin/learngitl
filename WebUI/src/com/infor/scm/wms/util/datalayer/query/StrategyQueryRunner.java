...
public class StrategyQueryRunner extends BaseQueryRunner{
	public static DataLayerResultWrapper getStrategyByStrategyKey(String strategyKey, WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper strategy = null;
		ArrayList parameters = new ArrayList();
		parameters.add(strategyKey);				
		strategy = DataLayerInterface.getResult(DataLayerQueryList.QUERY_STRATEGY_BY_STRATEGYKEY,parameters, context);
		return strategy;
	}	
}