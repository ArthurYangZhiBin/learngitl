...
public class PurchaseOrderQueryRunner extends BaseQueryRunner {
	
	public static DataLayerResultWrapper getPOByKey(String key, WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper po = null;
		ArrayList parameters = new ArrayList();
		parameters.add(key);
		po = DataLayerInterface.getResult(DataLayerQueryList.QUERY_PURCHASEORDER_BY_POKEY,parameters,context);
		return po;
	}
