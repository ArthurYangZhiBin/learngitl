...
public class PutawayZoneQueryRunner extends BaseQueryRunner{
	public static DataLayerResultWrapper getPutawayZoneByPutawayZone(String putawayZone, WMSValidationContext context) throws WMSDataLayerException{
		DataLayerResultWrapper putawayZoneRecord = null;
		ArrayList parameters = new ArrayList();
		parameters.add(putawayZone);				
		putawayZoneRecord = DataLayerInterface.getResult(DataLayerQueryList.QUERY_PUTAWAYZONE_BY_PUTAWAYZONE,parameters,context);
