...
public class WPListSelectQueryAction extends com.epiphany.shr.ui.action.ActionExtensionBase
{

	protected static ILoggerCategory _log = LoggerFactory.getInstance(WPListSelectQueryAction.class);
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		} catch (NullPointerException e)
		{
			...
			e.printStackTrace();
			_log.error("LOG_ERROR_EXTENSION_ListSelectQueryAction", "Unable to get Bio from List. BioRefString is "
					+ bioRefString, SuggestedCategory.NONE);
			return RET_CANCEL;
		}
		...
		{
			_log.debug("LOG_DEBUG_EXTENSION_ListSelectQueryAction", "Making a copy of attributes",
		...
		for (int i = 0; i < currentAttributes.size(); i++)
		{
			...
			{
				_log.error("LOG_ERROR_EXTENSION_ListSelectQueryAction", "Empty record, doing nothing",
						SuggestedCategory.NONE);
				return RET_CANCEL;
			}
