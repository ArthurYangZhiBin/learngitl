...
public class WPGraphicalRemovePKOfSavedFilter extends SaveAction{
	
	protected static ILoggerCategory _log = LoggerFactory.getInstance(WPGraphicalRemovePKOfSavedFilter.class);
	...
	protected int execute(ActionContext context, ActionResult result) throws UserException{	
		...
		WPUserUtil.setInteractionSessionAttribute(SESSION_KEY_SAVED_FILTER, null, state);				
		return RET_CONTINUE;	
	}
}
