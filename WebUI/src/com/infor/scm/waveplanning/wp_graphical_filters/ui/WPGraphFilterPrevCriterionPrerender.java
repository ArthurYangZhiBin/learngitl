...
public class WPGraphFilterPrevCriterionPrerender extends com.epiphany.shr.ui.view.customization.FormExtensionBase{
	protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form)throws EpiException {
		RuntimeFormWidgetInterface prevCriterionWidget = form.getFormWidgetByName("HISTORY");
		...
		prevCriterionWidget.setValue(criterion.get(criterion.size() - 1).toString());
		return RET_CONTINUE;
	}
}