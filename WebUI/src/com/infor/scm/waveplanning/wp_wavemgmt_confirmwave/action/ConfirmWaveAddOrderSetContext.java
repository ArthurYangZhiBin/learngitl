...
public class ConfirmWaveAddOrderSetContext extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	...
	protected int execute(ModalActionContext ctx, ActionResult args) throws EpiException
	{
		...
		try
		{
			...
			RuntimeFormWidgetInterface orderChoices = modalForm.getFormWidgetByName("ADDORDERSCHOICES");
			if (orderChoices.getValue() == null)
			{
				//throw exception
			}
			String choice = orderChoices.getValue().toString();
			userContext.put(CONTEXT_WAVEMGMT_ADDORDERCHOICE, choice);
