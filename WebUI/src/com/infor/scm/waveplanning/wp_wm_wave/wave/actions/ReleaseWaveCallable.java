...
/**
 * TODO Document ReleaseWaveCallable class.
 *
 * @author <a
 *         href="http://wiki.infor.com/confluence/display/InforArchitecture/Infor+IDE">
 *         Infor IDE Team</a>
 */
public class ReleaseWaveCallable implements Callable{
	...
	public Integer call () throws WebuiException {
		waveInput.setProcedureName(WPConstants.RELEASE);
		...
		waveInput.getProcedureParametes().add(new TextData("0"));
		waveInput.getProcedureParametes().add(new TextData("Y"));
