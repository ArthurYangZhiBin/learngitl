...
public class WaveMaintViewTaskByOrder extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		userContext.put(CONTEXT_WAVEMGMT_TASKVIEW_TYPE, "ORDER");
		
		RuntimeFormInterface currentRuntimeForm = state.getCurrentRuntimeForm();

		result.setFocus(currentRuntimeForm.getFocus());
