...
public class WaveMaintViewTaskByWave extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(WaveMaintViewTaskByWave.class);
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		userContext.put(CONTEXT_WAVEMGMT_TASKVIEW_TYPE, "WAVE");
