...
public class WaveMaintSelectCurrentWave extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		RuntimeFormInterface parentForm = toolbar.getParentForm(state);
		...
		{
			result.setFocus(parentForm.getFocus());
