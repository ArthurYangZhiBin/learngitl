...
public class WorkOrderFilter extends com.epiphany.shr.ui.action.ActionExtensionBase{
	public WorkOrderFilter(){
	}
	
	
	protected static ILoggerCategory _log = LoggerFactory.getInstance(WorkOrderFilter.class);
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		_log.debug("LOG_DEBUG_EXTENSION_Wave_Work_order_execute", "Entering WorkOrderFilter",
		...
		Query qry = new Query("wp_vWorkOrders", "wp_vWorkOrders.WAVEKEY='"+wmsWaveKey+"'", null);
