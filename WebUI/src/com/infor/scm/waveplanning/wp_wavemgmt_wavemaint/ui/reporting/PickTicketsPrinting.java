...
public class PickTicketsPrinting implements ReportingInterface{
...
System.out.println("***** it is in Pick Ticketing Reports *********");
	    ...
	    paramsAndValues.put("p_ExtOrdStart","0000000000");
	    paramsAndValues.put("p_ExtOrdEnd","ZZZZZZZZZZ");		    
	    paramsAndValues.put("p_pdateFrom",pStartDate);
	    paramsAndValues.put("p_pdateEnd",pEndDate);
	    String report_url= ReportUtil.retrieveReportURL(state,"CRPT55", paramsAndValues);
