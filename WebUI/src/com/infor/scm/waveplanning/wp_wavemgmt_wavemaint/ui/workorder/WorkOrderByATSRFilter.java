...
public class WorkOrderByATSRFilter extends com.epiphany.shr.ui.action.ActionExtensionBase{
	public WorkOrderByATSRFilter(){
	}
	
	
	protected static ILoggerCategory _log = LoggerFactory.getInstance(WorkOrderByATSRFilter.class);
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		_log.debug("LOG_DEBUG_EXTENSION_Wave_Work_order_execute", "Entering WorkOrderFilter",SuggestedCategory.NONE); 
...
System.out.println("&&&&& wave key="+wmsWaveKey);	       		
		Query qry = new Query("wp_vWorkOrderATSRequest", "wp_vWorkOrderATSRequest.WAVEKEY='"+wmsWaveKey+"'", null);
