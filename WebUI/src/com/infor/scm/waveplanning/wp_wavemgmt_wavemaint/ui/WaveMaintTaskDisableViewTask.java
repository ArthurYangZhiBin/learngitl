...
public class WaveMaintTaskDisableViewTask extends com.epiphany.shr.ui.view.customization.FormExtensionBase
{
	...
	protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form) throws EpiException
	{
		...
		try
		{
			...
			int status = BioAttributeUtil.getInt(focus, "STATUS");

			if (status >= 19)
			{
				form.getFormWidgetByName("TASKLIST").setBooleanProperty(RuntimeFormWidgetInterface.PROP_HIDDEN, false);
			}
