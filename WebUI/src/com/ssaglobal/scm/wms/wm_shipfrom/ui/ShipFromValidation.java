...
import com.ssaglobal.scm.wms.wm_shipto.ui.ShipToValidation;

/**
 * TODO Document ShipFromValidation class.
 *
 * @author <a
 *         href="http://wiki.infor.com/confluence/display/InforArchitecture/Infor+IDE">
 *         Infor IDE Team</a>
 */
public class ShipFromValidation extends com.epiphany.shr.ui.action.ActionExtensionBase{
	...
	protected int execute(ActionContext context, ActionResult result)
		...
		storerFocus.setValue("TYPE", "12");
		String shipFrom = storerFocus.getValue("STORERKEY").toString();
		storerFocus.setValue("STORERKEY", shipFrom.toUpperCase());
	...
	class GeneralTab extends Tab {
		...
		void ownerDuplication() throws DPException, UserException {
			...
			String query = "SELECT * FROM STORER WHERE (STORERKEY = '" + ownerValue + "' AND TYPE='12')";
