...
public class LPCreateTrailerLoadID extends com.epiphany.shr.ui.action.ActionExtensionBase {
	...
	protected int execute(ModalActionContext ctx, ActionResult args) throws EpiException {
		...
		String paramName = getParameterString("param_name");
		if (ctx.getSourceWidget().getName().equalsIgnoreCase("YES")){
			userContext.put(paramName, "YES");
		}else{
			userContext.put(paramName, "NO");
		}
