...
package com.ssaglobal.scm.wms.wm_label_printer.ui;
...
public class KShipPreRender extends com.epiphany.shr.ui.view.customization.FormExtensionBase {

	protected static ILoggerCategory _log = LoggerFactory.getInstance(KShipPreRender.class);
	...
	protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form)
		...
		try {
			...
			if (spsInstalled.isOff()) {
				_log.debug("LOG_DEBUG_EXTENSION_KShipPreRender_preRenderForm", "Disabling form", SuggestedCategory.NONE);
				form.setBooleanProperty(RuntimeFormInterface.PROP_READONLY, true);
			} else {
				_log.debug("LOG_DEBUG_EXTENSION_KShipPreRender_preRenderForm", "Enabling form", SuggestedCategory.NONE);
				form.setBooleanProperty(RuntimeFormInterface.PROP_READONLY, false);
			}
