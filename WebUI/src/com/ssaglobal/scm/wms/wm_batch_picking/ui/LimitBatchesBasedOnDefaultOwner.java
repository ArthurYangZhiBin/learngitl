...
public class LimitBatchesBasedOnDefaultOwner extends ActionExtensionBase{
	
	protected static ILoggerCategory _log = LoggerFactory.getInstance(LimitBatchesBasedOnDefaultOwner.class);
...
//			throw new UserException(errorMsg,new Object[0]);
		...
		try {
			focus.filterInPlace(new Query("wm_wave","DPE('SQL','(@[wm_wave.WAVEKEY] IN (SELECT WAVEKEY FROM WAVEDETAIL, ORDERS WHERE WAVEDETAIL.ORDERKEY = ORDERS.ORDERKEY AND ("+lockedOwnerClause+")))')",""));
