...
public class SKUTableValidationAllowEmpty extends com.epiphany.shr.data.bio.extensions.BioExtensionBase
{
	...
	protected static ILoggerCategory _log = LoggerFactory.getInstance(SKUTableValidationAllowEmpty.class);

	public SKUTableValidationAllowEmpty()
	{
