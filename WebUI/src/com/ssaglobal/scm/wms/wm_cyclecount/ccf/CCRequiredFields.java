 ...
 */
public class CCRequiredFields extends com.epiphany.shr.ui.action.ccf.SendAllWidgetsValuesExtensionBase
{
			...
			throws EpiException
	{
		...
		setProperty(form.getFormWidgetByName("SKU"), "input type", "normal" );
		setProperty(form.getFormWidgetByName("SKU"), "label class", "epnyLabel");
		return RET_CONTINUE;
