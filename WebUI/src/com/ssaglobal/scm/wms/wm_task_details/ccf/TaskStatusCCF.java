 ...
 */
public class TaskStatusCCF extends com.epiphany.shr.ui.action.ccf.SendAllWidgetsValuesExtensionBase
{
	...
	protected int execute(RuntimeFormInterface form, RuntimeFormWidgetInterface formWidget, HashMap params) throws EpiException
	{
		...
		try
		{
			statusValue = params.get("fieldValue").toString();
		...
		{
			setValue(form.getFormWidgetByName("REASONKEY"), " ");
			setValue(form.getFormWidgetByName("USERKEY"), " ");
			setValue(form.getFormWidgetByName("USERKEYOVERRIDE"), " ");
		}
