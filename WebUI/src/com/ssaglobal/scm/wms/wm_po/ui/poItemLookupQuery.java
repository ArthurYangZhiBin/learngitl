...
public class poItemLookupQuery extends ActionExtensionBase {

	protected static ILoggerCategory _log = LoggerFactory.getInstance(poItemLookupQuery.class);

	//Specific query for an item lookup that only returns the selected owner 
	protected int execute(ActionContext context, ActionResult result)throws EpiException{

		String[] parameters = new String[1];
		parameters[0] = "Buyer/Owner";
		...
		RuntimeFormInterface normalHeaderForm = state.getRuntimeForm(headerTbgrpSlot, "tab 1");
