...
public class NoEditBasedOnAttribute extends com.epiphany.shr.ui.view.customization.FormExtensionBase
{
	...
	protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form) throws EpiException
	{
		...
		try
		{
			...
			else
			{
				...
				RuntimeFormInterface otherForm = FormUtil.findForm(state.getCurrentRuntimeForm(), "wms_list_shell",
																	otherFormName, state);
			...
			if (attributeValue.toString().equalsIgnoreCase(value))
			{
				...
				{
					form.getFormWidgetByName(it.next().toString()).setBooleanProperty(
