...
public class SingleDuplicateValidationAction extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	 ...
	 */
	protected static ILoggerCategory _log = LoggerFactory.getInstance(SingleDuplicateValidationAction.class);
			...
			throws EpiException
	{
		...
		String attributeValue = (String) widget.getValue();

		_log.debug("LOG_SYSTEM_OUT","!! Widget: " + widgetName + " Value: " + attributeValue,100L);
		...
		if (results.size() >= 1)
		{
			...
			throw new FieldException(form, widgetName, ERROR_MESSAGE, parameters);
