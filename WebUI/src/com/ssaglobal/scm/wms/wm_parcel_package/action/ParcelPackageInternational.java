...
public class ParcelPackageInternational extends
	...
	protected int execute(ActionContext context, ActionResult result)
		...
		actionProperties.setProcedureName("SPSInternationalData");
		...
		if(errorMsg != null && !StringUtils.isBlank(errorMsg.getAsString())){
			throw new UserException("WMEXP_SPS_NO_DATA", new Object[]{});
		}
