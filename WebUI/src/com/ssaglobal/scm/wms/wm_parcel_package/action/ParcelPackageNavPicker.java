...
public class ParcelPackageNavPicker extends com.epiphany.shr.ui.action.ActionExtensionBase {
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException {
		...
		RuntimeFormInterface parentForm = state.getCurrentRuntimeForm().getParentForm(state);
		String name = parentForm.getName();
		if ("wms_list_shell".equals(name)) {
			context.setNavigation("STANDALONE");
		} else {
			context.setNavigation("SO");
		}
