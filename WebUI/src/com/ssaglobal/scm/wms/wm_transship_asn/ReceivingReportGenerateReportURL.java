...
public class ReceivingReportGenerateReportURL extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	private final SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-mm-dd");
	private final SimpleDateFormat timeFormat = new SimpleDateFormat("hh:mm:ss");

	protected static ILoggerCategory _log = LoggerFactory.getInstance(ReceivingReportGenerateReportURL.class);
	/**
	...
	{		
		...
		RuntimeFormInterface detailForm = FormUtil.findForm(state.getCurrentRuntimeForm(),"wms_list_shell","wm_transship_asn_header_detail_view",state);
		if(detailForm != null)
		...
		params.put("p_pTransASNStart",selection.get("TRANSASNKEY"));
		params.put("p_pTransASNEnd",selection.get("TRANSASNKEY"));
		params.put("p_pStartDate",startDate);
		params.put("p_pEndDate",endDate);
		String reportUrl = ReportUtil.retrieveReportURL(state,"CRPT71",params);
