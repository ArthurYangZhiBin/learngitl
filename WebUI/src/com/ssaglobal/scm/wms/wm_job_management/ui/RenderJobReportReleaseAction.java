...
public class RenderJobReportReleaseAction extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
     ...
     */
	protected static ILoggerCategory _log = LoggerFactory.getInstance(RenderJobReportReleaseAction.class);
	...
	protected int preRenderForm(ModalUIRenderContext context, RuntimeNormalFormInterface form)
	  ...
	  String reportName = getParameter("REPORTNAME").toString();
	  String  report_url="";
	  if (reportName.equalsIgnoreCase("PickListReport")&& session.getAttribute("PickListReportURL") != null){
		  report_url = session.getAttribute("PickListReportURL").toString();
		  RuntimeFormWidgetInterface reportFrame = form.getFormWidgetByName("reports");
		  reportFrame.setProperty(reportFrame.PROP_SRC,report_url);
	  }else{
//		  return RET_CANCEL;
	  }
	  if (reportName.equalsIgnoreCase("printWorkorderPacket")&& session.getAttribute("printWorkorderPacketURL") !=null){
		  report_url = session.getAttribute("printWorkorderPacketURL").toString();
		  RuntimeFormWidgetInterface reportFrame = form.getFormWidgetByName("reports");
		  reportFrame.setProperty(reportFrame.PROP_SRC,report_url);
...
//		  return RET_CANCEL;
	  ...
	  if (reportName.equalsIgnoreCase("printWorkorderBom")&& session.getAttribute("printWorkorderBomURL") !=null){
		  report_url = session.getAttribute("printWorkorderBomURL").toString();
		  RuntimeFormWidgetInterface reportFrame = form.getFormWidgetByName("reports");
		  reportFrame.setProperty(reportFrame.PROP_SRC,report_url);
	  }else{
//		  return RET_CANCEL;
