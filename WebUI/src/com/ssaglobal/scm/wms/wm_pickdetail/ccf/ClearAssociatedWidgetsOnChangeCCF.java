 ...
 */
public class ClearAssociatedWidgetsOnChangeCCF extends com.epiphany.shr.ui.action.ccf.SendAllWidgetsValuesExtensionBase
{
			...
			throws EpiException
	{
		...
		for(Iterator it = widgets.iterator(); it.hasNext(); )
		{
			...
			setValue(form.getFormWidgetByName(widgetName), "");
		}
