 ...
 */
public class PickDisableWidgetCCF extends com.epiphany.shr.ui.action.ccf.SendAllWidgetsValuesExtensionBase
{
			...
			throws EpiException
	{
		...
		listParams(params);
		setProperty(form.getFormWidgetByName("TOLOC"), RuntimeFormWidgetInterface.PROP_READONLY, "true");
