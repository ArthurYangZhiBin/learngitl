...
public class DisableEnablePickDetailWgtsPreRender extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
    ...
    protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form)
       ...
       try {
    	   ...
    	   if(focus != null && !(focus instanceof QBEBioBean) && focus.getValue("STATUS").toString().equalsIgnoreCase("9"))
    	   {
	  		   form.getFormWidgetByName("GROSSWGT").setBooleanProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
	  		   form.getFormWidgetByName("NETWGT").setBooleanProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
	  		   form.getFormWidgetByName("TAREWGT").setBooleanProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
    	   }	  		   
