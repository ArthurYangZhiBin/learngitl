 ...
 */
package com.ssaglobal.scm.wms.wm_owner_billto.ui;
...
/**
 * TODO Document OwnerBillToValidation class.
 *
 * @author <a
 *         href="http://wiki.infor.com/confluence/display/InforArchitecture/Infor+IDE">
 *         Infor IDE Team</a>
 */
public class OwnerBillToValidation extends com.epiphany.shr.ui.action.ActionExtensionBase{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(storerSaveValidationAction.class);

	@Override
	protected int execute(ActionContext context, ActionResult result)
			throws EpiException {
		String shellFormName = "wm_list_shell_owner_billto";
		String generalFormTab = "wm_owner_billto_general";
		...
		storerFocus.setValue("TYPE", "14");
		String ownerBillTo = storerFocus.getValue("STORERKEY").toString();
		storerFocus.setValue("STORERKEY", ownerBillTo.toUpperCase());
	...
	class GeneralTab extends Tab {
		...
		void ownerDuplication() throws DPException, UserException {
			...
			String query = "SELECT * FROM STORER WHERE (STORERKEY = '" + ownerValue + "' AND TYPE='14')";
