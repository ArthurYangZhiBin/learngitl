...
public class WmsWebuiValidationInsertImpl {
	protected static ILoggerCategory _log = LoggerFactory.getInstance(WmsWebuiValidationInsertImpl.class);
	protected static final String internalCaller = "internalCall";
	
	public static EXEDataObject insert(String insertSql) throws DPException
	{		
		...
		try
		{
			...
			EXEDataObject obj = remote.insert(new TextData(wmWhseID),db_connection, new TextData(insertSql), true, null,internalCaller,null);
			return obj;
		}
		catch (Exception ex)
		{
	...
	public static EXEDataObject insert(String insertSql, String db_connection, String wmWhseID) throws DPException
	{				
		try
		{
			TransactionServiceSORemote remote = EJBRemote.getRemote();			
