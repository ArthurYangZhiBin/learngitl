...
public class AdjustmentHeaderChargeInfoUpdate extends ActionExtensionBase {
	/******************************************************************
	...
	protected int execute(ActionContext context, ActionResult result) throws UserException, EpiDataException, EpiException{
		...
		/*if(form1.isListForm()){ 			
			...
			for (int i = 0; i < focus.size(); i++){				
				...
				String WhereClause = " Where TYPE = 'AJ' and  TRAN_KEY1 = '"+ADJUSTMENTKEY+"'AND TRAN_KEY2 = 0 AND CHARGE_CODE ='"+ChargeCodeValue+"' ";
