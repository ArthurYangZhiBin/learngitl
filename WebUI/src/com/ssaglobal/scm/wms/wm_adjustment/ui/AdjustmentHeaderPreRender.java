...
public class AdjustmentHeaderPreRender extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
    ...
    protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form)
       ...
       try {
    	   ...
    	   if (focus.isTempBio())
    	   {
    		   //Form is a new record
    		   RuntimeFormWidgetInterface addWhoWidget = form.getFormWidgetByName("ADDWHO");
    		   RuntimeFormWidgetInterface effectiveDateWidget = form.getFormWidgetByName("EFFECTIVEDATE");
    		   addWhoWidget.setProperty(RuntimeFormWidgetInterface.PROP_HIDDEN, true);
    		   //effectiveDateWidget.setProperty(RuntimeFormWidgetInterface.PROP_HIDDEN, true); //mkosel
    	   }
