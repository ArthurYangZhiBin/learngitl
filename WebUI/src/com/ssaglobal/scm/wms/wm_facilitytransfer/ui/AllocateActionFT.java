...
import com.ssaglobal.scm.wms.wm_facility_maintenance.CheckFacilityRecord;

public class AllocateActionFT extends ActionExtensionBase{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(AllocateActionFT.class);
	protected int execute(ActionContext context, ActionResult result) throws EpiException{
		_log.debug("LOG_SYSTEM_OUT","Executes stored proceedure name:NSPORDERPROCESSING params:orderkey, oskey, docarton, doroute, tblprefix, preallocateonly",100L);
