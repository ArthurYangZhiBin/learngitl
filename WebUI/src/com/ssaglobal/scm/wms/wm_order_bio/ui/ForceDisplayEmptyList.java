...
public class ForceDisplayEmptyList extends ActionExtensionBase {
	...
	protected int execute( ActionContext context, ActionResult result ) throws EpiException {
		if(result.getFocus() instanceof BioCollectionBean)
			((BioCollectionBean)result.getFocus()).setEmptyList(true);
		return RET_CONTINUE;
	}
}
