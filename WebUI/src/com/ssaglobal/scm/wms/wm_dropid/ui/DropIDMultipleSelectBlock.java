...
public class DropIDMultipleSelectBlock extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(DropIDMultipleSelectBlock.class);
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		if (toggleForm.isListForm())
		{
			listForm = (RuntimeListFormInterface) toggleForm;
		}
		else
		{
			throw new UserException("WMEXP_DELETE_FROM_DETAIL_VIEW", process);
		}
