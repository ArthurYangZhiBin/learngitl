 ...
 **********************************************************************************/
public class OrderContainerActivity extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(OrderSheetGenerateReportURL.class);

	private static final String REPORTID = "CRPT998";
...
//SCM-00000-04707		parametersAndValues.put("p_ordEnd", orderKey);
		parametersAndValues.put("p_RDateFrom", pStartDate);
		parametersAndValues.put("p_RDateTo", pEndDate);
		parametersAndValues.put("p_DocumentIDStartS",  orderKey);
		parametersAndValues.put("p_DocumentIDEndS",orderKey);
		
		String ownerStartS = "0"; 
		String ownertEndS = "ZZZZZZZZZZZZZZZ";
		parametersAndValues.put("p_pOwnerFrom",ownerStartS);
		parametersAndValues.put("p_OwnerTo", ownertEndS);
		
		String DOC_TYPE = "WD";
		parametersAndValues.put("p_DOC_TYPE", DOC_TYPE);
