...
public class ManualPosting extends ActionExtensionBase {
	protected int execute(ActionContext context, ActionResult result) throws UserException {
		...
		try {
			if (headerFocus.isTempBio()) {
				...
				try {
					...
					throw new UserException("请打开需要手工过账的单据进行该操作!", new Object[]{});
				}
			}
		} catch (EpiException e) {
			throw new UserException("手工过账异常-ManualPosting!", new Object[]{});
		}
		...
		String query = "UPDATE ORDERS SET ORDERGROUP = '666666' WHERE ORDERKEY = '" + orderkey + "' " +
