...
public class RFPickTaskRpt extends com.epiphany.shr.ui.action.ActionExtensionBase {
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		String baseURL = PropertyUtil.readValue(filePath, "Pick_Report");
		...
		String url = baseURL+"?dataSource="+currentConnection+"&userid=" + userName+ "&whseid="+wmWhseID + "&orderkey="+orderKey+"&rptType=1";
