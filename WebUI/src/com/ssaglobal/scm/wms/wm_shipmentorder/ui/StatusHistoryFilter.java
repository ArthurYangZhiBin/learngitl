...
public class StatusHistoryFilter extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
    ...
    protected int preRenderListForm(UIRenderContext context, RuntimeListFormInterface form)
       ...
       try {
           ...
           BioCollectionBean orderStatuses = (BioCollectionBean)form.getFocus();
           
           String stmt = "wm_orderstatushistory.ORDERLINENUMBER = '' OR wm_orderstatushistory.ORDERLINENUMBER = ' ' ";
           Query query = new Query("wm_orderstatushistory", stmt, null);
           
           BioCollectionBean filteredStatuses = (BioCollectionBean)orderStatuses.filter(query);
           form.setFocus( filteredStatuses);
