...
public class PickRpt extends com.epiphany.shr.ui.action.ActionExtensionBase {
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		String url = baseURL+"?dataSource="+currentConnection+"&userid=" + userName+ "&whseid="+wmWhseID + "&orderkey="+orderKey+"&rptType=0";
