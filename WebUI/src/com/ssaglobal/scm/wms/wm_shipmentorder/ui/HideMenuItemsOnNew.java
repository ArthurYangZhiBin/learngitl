...
public class HideMenuItemsOnNew extends com.epiphany.shr.ui.view.customization.MenuExtensionBase {

	protected static ILoggerCategory _log = LoggerFactory.getInstance(HideMenuItemsOnNew.class);
	...
	protected int execute(StateInterface state, RuntimeMenuItemInterface menuItem) {
		...
		_log.debug(	"LOG_DEBUG_EXTENSION_HideMenuItems",
					"Menu Item " + menuItem.getName() + ", Bean Type: " + focus.getBeanType(),
