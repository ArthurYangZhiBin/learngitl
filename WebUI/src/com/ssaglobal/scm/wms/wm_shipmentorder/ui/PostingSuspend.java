...
public class PostingSuspend extends ActionExtensionBase {
	protected int execute(ActionContext context, ActionResult result) throws UserException {
		...
		try {
			if (headerFocus.isTempBio()) {
				...
				try {
					...
					throw new UserException("请打开需要暂停过账的单据进行该操作!", new Object[]{});
				}
			}
		} catch (EpiException e) {
			throw new UserException("暂停过账异常-ManualPosting!", new Object[]{});
		}
		...
		String query = "UPDATE ORDERS SET ORDERGROUP = '888888' WHERE ORDERKEY = '" + orderkey + "' " +
				"AND (ORDERGROUP IS NULL OR ORDERGROUP = '' OR ORDERGROUP = ' ')";
