...
public class SOChargeInfoBillCheckAction extends ActionExtensionBase {
	...
	protected int execute(ActionContext context, ActionResult result) throws UserException, EpiDataException, EpiException{
		...
		if(form1.isListForm()){
			...
			{				
				...
				String mySql ="UPDATE BILL_CHARGEINSTRUCT SET BILL_CHECK = 1, BILL_CHECK_UID = '"+userLoginId+"', BILL_CHECK_DT ='"+ dateVal+"' WHERE TYPE = 'SO' AND TRAN_KEY1 = '"+OrderKey+"' AND TRAN_KEY2 ='0'";
				try
				{
