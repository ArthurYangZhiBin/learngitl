...
public class CCFDoorLocationValidation extends com.epiphany.shr.ui.action.ccf.SendAllWidgetsValuesExtensionBase
{
	@Override
			...
			throws EpiException
	{
		...
		if(queryStatement!=params.get("fieldValue")){
			...
			queryStatement = "wm_location.LOC = '" + widgetValue + "'" + " AND (wm_location.LOCATIONTYPE = 'STAGED' OR wm_location.LOCATIONTYPE = 'DOOR') ";
