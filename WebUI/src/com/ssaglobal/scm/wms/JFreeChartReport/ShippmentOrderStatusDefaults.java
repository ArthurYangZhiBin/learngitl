...
public class ShippmentOrderStatusDefaults extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
    ...
    protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form) throws EpiException 
    {
       try 
       {
 			...
 			RuntimeFormInterface currentForm = state.getCurrentRuntimeForm();
  	   	    ...
  	   	    {
  	   	    	temp = (Calendar)session.getAttribute("wm_sdate_param");
  	   	    }
 	   	    ...
 	   	    {
 	   	    	numDays = (String)session.getAttribute("wm_days_param");
 	   	    }
	   	    num.setValue(numDays); 	   	       		
 	  	      	   							
 			session.setAttribute("wm_sdate_param", temp);
 			session.setAttribute("wm_days_param", numDays); 	
       } 
       catch(Exception e) 
       {
