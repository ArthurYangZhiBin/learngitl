...
public class TaskDetailStatusDefaults extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
        ...
        try 
        {
 			...
 			RuntimeFormInterface currentForm = state.getCurrentRuntimeForm();
  	   	    ...
  	   	    Calendar temp = Calendar.getInstance();  	   	    
   	   	    ...
   	   	    {
   	   	    	temp = (Calendar)session.getAttribute("TDwm_sdate_param");
   	   	    }
  	   	    ...
  	   	    {
  	   	    	numDays = (String)session.getAttribute("TDwm_days_param");
  	   	    } 	
  	   	    num.setValue(numDays);
  	  	      	   							
  			session.setAttribute("TDwm_sdate_param", temp);
  			session.setAttribute("TDwm_days_param", numDays); 	
        } 
        catch(Exception e) 
        {             
           // Handle Exceptions 
