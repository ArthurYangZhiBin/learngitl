...
public class CXAdjustmentDetailPrerender extends com.epiphany.shr.ui.view.customization.FormExtensionBase {

    protected static ILoggerCategory _log = LoggerFactory.getInstance(CXAdjustmentDetailPrerender.class);

    public CXAdjustmentDetailPrerender() { 
        _log.debug("EXP_1","CXAdjustmentDetailPrerender Instantiated!!!",  SuggestedCategory.NONE);
    }
    ...
    protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form)
		...
		if(focus.isTempBio())
		{
			  ...
			  form.getFormWidgetByName("CARTONIZATIONKEY").setBooleanProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
	  		  form.getFormWidgetByName("CARTONDESC").setBooleanProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
	 		 ...
	 		 form.getFormWidgetByName("CARTONDESC").setDisplayValue(cartonDesc);     		  		   
