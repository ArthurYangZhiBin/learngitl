...
import com.ssaglobal.scm.wms.wm_batch_picking.ui.BatchPickingShipWave;

public class PopulateCarrier extends PopulateBase{

	protected static ILoggerCategory _log = LoggerFactory.getInstance(PopulateCarrier.class);
	public PopulateBioType ValidateAndLoad(DataBean dupDataBean, QBEBioBean newBioBean) {
		...
		try{
			...
			**/
			...
			_log.debug("LOG_SYSTEM_OUT","Error populating Carrier."+e.getMessage(),100L);
			e.printStackTrace();
