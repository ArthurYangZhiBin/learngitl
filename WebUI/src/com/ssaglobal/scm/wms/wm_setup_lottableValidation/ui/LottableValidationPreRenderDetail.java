...
import com.ssaglobal.scm.wms.wm_serial_number.ui.SNDetailSerialValidate;
...
public class LottableValidationPreRenderDetail extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
     ...
     */
	protected static ILoggerCategory _log = LoggerFactory.getInstance(LottableValidationPreRenderDetail.class);
	...
	protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form)throws EpiException 
	{
		try 
		{
			...
			_log.debug("LOG_SYSTEM_OUT","current form is "+currentForm.getName(),100L);
			...
			for ( int idx = 1; idx <= 12; ++idx )
			{
				...
				String newVal = tempVal == null || tempVal.equals("NONE") ? "0" : "1";
