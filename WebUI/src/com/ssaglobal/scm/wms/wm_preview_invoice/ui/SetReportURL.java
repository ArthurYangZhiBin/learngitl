...
public class SetReportURL extends com.epiphany.shr.ui.view.customization.FormExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(SetReportURL.class);
	...
	protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form) throws EpiException
	{
		...
		try
		{
			...
			String reportUrl = (String) userCtx.get("REPORTURL");
			_log.debug("LOG_DEBUG_EXTENSION_SetReportURL", "Report URL from context: " + reportUrl,
			...
			_log.debug("LOG_DEBUG_EXTENSION_SetReportURL", "Report URL from widget: "
