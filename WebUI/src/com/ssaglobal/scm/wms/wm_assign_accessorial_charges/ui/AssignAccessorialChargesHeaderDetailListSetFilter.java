...
public class AssignAccessorialChargesHeaderDetailListSetFilter extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		EpnyUserContext userContext = context.getServiceManager().getUserContext();
			...
			String formBioType = getParameterString("LISTBIO");
