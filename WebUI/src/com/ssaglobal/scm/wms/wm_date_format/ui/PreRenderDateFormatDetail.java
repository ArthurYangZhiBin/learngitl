...
import com.ssaglobal.scm.wms.wm_date_format.ui.EnableDisableCustomButton;
...
public class PreRenderDateFormatDetail extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
     ...
     */
	protected static ILoggerCategory _log = LoggerFactory.getInstance(PreRenderDateFormatDetail.class);
    protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form)
       ...
       try {
		...
		EnableDisableCustomButton.setDetailEnableDisableProperties(state, form);
