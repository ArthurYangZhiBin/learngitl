...
public class UpdateAtEnterprise extends com.epiphany.shr.ui.view.customization.FormExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(UpdateAtEnterprise.class);
	...
	{
		_log.debug("LOG_DEBUG_EXTENSION", "\n\n+++++Starting UpdateAtWarehouse permissionsPreRender", SuggestedCategory.NONE);
		try
		{
	...
	private void handleWarehousePermissions(UIRenderContext context, RuntimeNormalFormInterface form)
	{
		...
		{
			_log.debug("LOG_DEBUG_EXTENSION", "\n'''Form is of type  Toolbar", SuggestedCategory.NONE);
