 ...
 *******************************************************************************/
package com.ssaglobal.scm.wms.wm_vendor.ui;
...
import com.ssaglobal.scm.wms.wm_task_details.ui.CalculateQty;

public class PopulateVendor extends PopulateBase {

	protected static ILoggerCategory _log = LoggerFactory.getInstance(PopulateVendor.class);
