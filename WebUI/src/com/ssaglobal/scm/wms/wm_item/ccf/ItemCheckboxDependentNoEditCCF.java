...
public class ItemCheckboxDependentNoEditCCF extends com.epiphany.shr.ui.action.ccf.SendAllWidgetsValuesExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(ItemCheckboxDependentNoEditCCF.class);
	/**
	...
	protected int execute(RuntimeFormInterface form, RuntimeFormWidgetInterface formWidget, HashMap params)
			throws EpiException
	{
		_log.debug("LOG_DEBUG_EXTENSION", "\n\n\n@#$@#$Start of ItemCheckboxDependentNoEditCCF", SuggestedCategory.NONE);
		String checkboxName;
