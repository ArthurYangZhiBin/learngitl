...
public class SetListFormAfterSave extends com.epiphany.shr.ui.view.customization.FormExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(SetListFormAfterSave.class);
	...
	protected int modifySubSlots(UIRenderContext context, RuntimeFormExtendedInterface form) throws EpiException
	{
		...
		try
		{
			String saveActionName = getParameterString("SAVE", "SAVE");
			...
			if (saveActionName.equals(actionName))
			{
