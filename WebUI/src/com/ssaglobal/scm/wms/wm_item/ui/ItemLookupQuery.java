...
public class ItemLookupQuery extends ActionExtensionBase
{
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		value = currentFormFocus.getValue("STORERKEY") == null ? null : currentFormFocus.getValue("STORERKEY").toString().toUpperCase() ;
