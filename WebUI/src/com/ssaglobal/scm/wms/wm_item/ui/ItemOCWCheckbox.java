...
public class ItemOCWCheckbox extends com.epiphany.shr.ui.action.ActionExtensionBase
{
protected static ILoggerCategory _log = LoggerFactory.getInstance(ItemOCWCheckbox.class);
	/**
		...
		try
		{
			...
			if ((checkboxValue.equals("0")) || (checkboxValue.equals("N"))) // Unchecked
			{
				_log.debug("LOG_DEBUG_EXTENSION", "//// Checkbox " + checkboxName + " is UnChecked, Value: " + checkboxValue
						+ " Enabling 'Allow Customer Override' and UnChecking", SuggestedCategory.NONE);
				...
				allowCustomerOverrideWidget.setProperty(RuntimeFormWidgetInterface.PROP_READONLY, "false");
				allowCustomerOverrideWidget.setDisplayValue("0");
			}
			else if ((checkboxValue.equals("1")) || (checkboxValue.equals("Y"))) // Checked
			{
				_log.debug("LOG_DEBUG_EXTENSION", "//// Checkbox " + checkboxName + " is Checked, Value: " + checkboxValue
						+ " Disabling 'Allow Customer Override' and Unchecking", SuggestedCategory.NONE);
				//System.out.println("//// Checkbox " + checkboxName + " is Checked, Value: " + checkboxValue
				//		+ " Disabling 'Allow Customer Override' and Unchecking");
				RuntimeFormWidgetInterface allowCustomerOverrideWidget = form.getFormWidgetByName("OACOVERRIDE");
				allowCustomerOverrideWidget.setProperty(RuntimeFormWidgetInterface.PROP_READONLY, "true");
				allowCustomerOverrideWidget.setDisplayValue("0");
