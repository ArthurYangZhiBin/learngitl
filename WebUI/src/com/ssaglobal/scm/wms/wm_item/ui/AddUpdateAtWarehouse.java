...
public class AddUpdateAtWarehouse extends com.epiphany.shr.ui.view.customization.FormExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(AddUpdateAtWarehouse.class);
	/**
	...
	private int permissionsPreRender(UIRenderContext context, RuntimeFormBasicInterface form)
	{
		_log.debug("LOG_DEBUG_EXTENSION", "\n\n+++++Starting AddUpdateAtWarehouse permissionsPreRender", SuggestedCategory.NONE);
		try
		{
	...
	private void handleWarehousePermissions(UIRenderContext context, RuntimeFormBasicInterface form)
	{
		...
		if (formName.endsWith("Toolbar"))
		{
			...
			{
				RuntimeFormWidgetInterface saveButton = form.getFormWidgetByName("SAVE");
				saveButton.setBooleanProperty(RuntimeFormWidgetInterface.PROP_READONLY, false);
			}
	...
	private void handleEnterprisePermissions(UIRenderContext context, RuntimeFormBasicInterface form)
	{
		StateInterface state = context.getState();
		...
		if (formName.endsWith("Toolbar"))
		{
			_log.debug("LOG_DEBUG_EXTENSION", "\n'''Form is of type  Toolbar, Disabling New, Save buttons", SuggestedCategory.NONE);
...
//			if( form.isListForm() && getParameterBoolean("DISABLE_DETAIL?") == true)
//			{
//				_log.debug("LOG_DEBUG_EXTENSION", "'''Also Form is of type List Form, disabling detail view", SuggestedCategory.NONE);
//				RuntimeFormWidgetInterface detailButton = form.getFormWidgetByName("Detail");
