...
public class ItemRetrieveItemFromParent extends com.epiphany.shr.ui.view.customization.FormExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(ItemRetrieveItemFromParent.class);
	/**
	...
	protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form) throws EpiException
	{
		...
		try
		{
			...
			currentFormFocus.setValue(itemAttribute, parentFocus.getValue("SKU"));
