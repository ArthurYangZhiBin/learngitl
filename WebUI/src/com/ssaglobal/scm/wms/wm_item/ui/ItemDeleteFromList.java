...
public class ItemDeleteFromList extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	 ...
	 */
	protected static ILoggerCategory _log = LoggerFactory.getInstance(ItemDeleteFromList.class);
