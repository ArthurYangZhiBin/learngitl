...
public class PutItemPKInSession extends ActionExtensionBase{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(PutItemPKInSession.class);
	protected int execute(ActionContext context, ActionResult result) throws UserException{		
		HttpSession session = context.getState().getRequest().getSession();
		DataBean focus = result.getFocus();
		session.setAttribute("CURRENT_ITEM_PK",focus.getValue("SKU"));
		return RET_CONTINUE;
