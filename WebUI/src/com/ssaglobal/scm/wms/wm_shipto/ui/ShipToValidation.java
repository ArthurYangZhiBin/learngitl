 ...
 */
package com.ssaglobal.scm.wms.wm_shipto.ui;
...
/**
 * TODO Document ShipToValidation class.
 *
 * @author <a
 *         href="http://wiki.infor.com/confluence/display/InforArchitecture/Infor+IDE">
 *         Infor IDE Team</a>
 */
public class ShipToValidation extends com.epiphany.shr.ui.action.ActionExtensionBase{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(ShipToValidation.class);

	@Override
	protected int execute(ActionContext context, ActionResult result)
			throws EpiException {
		String shellFormName = "wm_list_shell_shipto";
		String generalFormTab = "wm_shipto_general";
		...
		storerFocus.setValue("TYPE", "10");
		String shipTo = storerFocus.getValue("STORERKEY").toString();
		storerFocus.setValue("STORERKEY", shipTo.toUpperCase());
		return RET_CONTINUE;
	...
	class GeneralTab extends Tab {
		...
		void ownerDuplication() throws DPException, UserException {
			...
			String query = "SELECT * FROM STORER WHERE (STORERKEY = '" + ownerValue + "' AND TYPE='10')";
