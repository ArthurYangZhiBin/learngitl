...
public class QCVeriftyFilter extends com.epiphany.shr.ui.view.customization.FormExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(QCVeriftyFilter.class);
	/**
	...
	protected int preRenderListForm(UIRenderContext context, RuntimeListFormInterface form) throws EpiException
	{
		...
		try
		{
			...
			//Query filterQry = new Query("wm_pickdetail", "wm_pickdetail.QTY = 2", null);
			Query filterQry = new Query("wm_qcverifydetail", "wm_qcverifydetail.QTYPICKED != wm_qcverifydetail.QTYVERIFIED", null);
