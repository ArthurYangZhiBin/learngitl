 ...
 *******************************************************************************/
package com.ssaglobal.scm.wms.wm_configurationTutorial;
...
import com.ssaglobal.scm.wms.wm_reports.ui.autoGeneratReportURL;

public class AutoGenerateConfigurationURL  extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
	...
	throws EpiException {
		...
		try {
			...
			_log.debug("LOG_SYSTEM_OUT","USER LOCALE = "+ userLocale,100L);
			String config_url = "help/wmsapp/"+ userLocale +"/WM_ConfigurationTutorial/WM_Configuration.html";
			RuntimeFormWidgetInterface configFrame = form.getFormWidgetByName("wm_configuration_tutorial_place_holder");
			configFrame.setProperty(configFrame.PROP_SRC,config_url);
