...
public class ClearSuspendedCriteria extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		SessionUtil.setInteractionSessionAttribute(SaveSuspendedCriteria.SUSPEND_ORDER_SEARCH, null, state);
