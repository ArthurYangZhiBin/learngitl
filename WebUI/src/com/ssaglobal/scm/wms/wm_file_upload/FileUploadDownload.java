...
public class FileUploadDownload extends ActionExtensionBase{
    protected static ILoggerCategory _log = LoggerFactory.getInstance(FileUploadDownload.class);

    
	protected int execute(ActionContext context, ActionResult result) throws UserException, EpiException {	
		
		StateInterface state = context.getState();							
		String fileURL = FileUtil.generateFileRequest((String)result.getFocus().getValue("FILEUPLOADPK"),state,Boolean.FALSE);					
