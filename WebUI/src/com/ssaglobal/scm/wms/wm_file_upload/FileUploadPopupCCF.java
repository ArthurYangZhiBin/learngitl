 ...
 */
public class FileUploadPopupCCF extends SendAllWidgetsValuesExtensionBase
{
	 ...
	 */
	protected static ILoggerCategory _log = LoggerFactory.getInstance(FileUploadPopupCCF.class);
			...
			throws EpiException
	{
		...
		formWidget.setProperty(RuntimeFormWidgetInterface.PROP_READONLY,Boolean.TRUE);
		return RET_CONTINUE;
	}
}
