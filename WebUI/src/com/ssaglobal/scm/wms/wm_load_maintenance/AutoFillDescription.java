...
public class AutoFillDescription extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
	...
	throws EpiException {
		...
		try {
			...
			String trailerNumber = form.getFormWidgetByName("TRAILERID").getDisplayValue() == null || form.getFormWidgetByName("TRAILERID").getDisplayValue().toString().matches("\\s*") ? "" : form.getFormWidgetByName("TRAILERID").getDisplayValue().toString();
