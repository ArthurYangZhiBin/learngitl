...
public class PalletRecapSummaryReportGenerateReportURL extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	//private SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-mm-dd");
	private final SimpleDateFormat timeFormat = new SimpleDateFormat("hh:mm:ss");

	protected static ILoggerCategory _log = LoggerFactory.getInstance(PalletRecapSummaryReportGenerateReportURL.class);
	/**
