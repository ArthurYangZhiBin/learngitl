...
public class LoadSummaryReportGenerateReportURL extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	//private SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-mm-dd");
	private final SimpleDateFormat timeFormat = new SimpleDateFormat("hh:mm:ss");


	protected static ILoggerCategory _log = LoggerFactory.getInstance(LoadSummaryReportGenerateReportURL.class);
	/**
	...
	{		
		...
		if(selection.get("DEPARTURETIME")!=null){			
			GregorianCalendar gc = (GregorianCalendar)selection.get("DEPARTURETIME");
		...
		params.put("p_rid","R08");		
		
		params.put("p_rtMin",selection.get("ROUTE"));
		params.put("p_rtMax",selection.get("ROUTE"));
		params.put("p_drMin",selection.get("DOOR"));
		params.put("p_drMax",selection.get("DOOR"));
		params.put("p_ldMin",selection.get("LOADID"));
		params.put("p_ldMax",selection.get("LOADID"));
		params.put("p_dtMin",startDate);
		params.put("p_dtMax",endDate);
		
		String reportUrl = ReportUtil.retrieveReportURL(state,"CRPT36",params);
