...
public class OutboundDocReportGenerateReportURL extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	//private SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-mm-dd");
	private final SimpleDateFormat timeFormat = new SimpleDateFormat("hh:mm:ss");
	

	protected static ILoggerCategory _log = LoggerFactory.getInstance(OutboundDocReportGenerateReportURL.class);
	/**
	...
	{		
		...
		params.put("P_LoadIdFrom",selection.get("LOADID"));				
		params.put("LoadIDTo",selection.get("LOADID"));
		params.put("p_RouteFrom",selection.get("ROUTE"));
		params.put("p_RouteTo",selection.get("ROUTE"));
		params.put("p_DoorFrom",selection.get("DOOR"));
		params.put("pDate",departureDate);				
		
		String reportUrl = ReportUtil.retrieveReportURL(state,"CRPT48",params);
