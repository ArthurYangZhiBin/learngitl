...
public class ValidateLocationOnChange extends ActionExtensionBase
{

	protected static ILoggerCategory _log = LoggerFactory.getInstance(ValidateLocationOnChange.class);
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		if(displayValue != null){
			...
			if(location != null && location.trim().length() > 0){
				Query loadBiosQry = new Query("wm_location", "wm_location.LOC = '"+location.toUpperCase()+"'", null);
