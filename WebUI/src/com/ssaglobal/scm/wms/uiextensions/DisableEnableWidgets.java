...
public class DisableEnableWidgets extends ActionExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(DisableEnableWidgets.class);
	public DisableEnableWidgets()
    {
    }
