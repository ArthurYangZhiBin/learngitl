...
public class MultipleSelectBlock  extends ActionExtensionBase{
    protected static ILoggerCategory _log = LoggerFactory.getInstance(MultipleSelectBlock.class);

    public MultipleSelectBlock() { 
    ...
    protected int execute(ActionContext context, ActionResult result) throws UserException {
    	...
    	if("Header".equalsIgnoreCase(headerOrDetail)){
    		...
    		if(headerForm.isListForm()){
    			...
    			throw new UserException("WMEXP_DELETE_FROM_HEADER_VIEW",process);
    		}
