...
public class KeyGenBioWrapper extends FormExtensionBase {
	...
	protected static final String internalCaller = "internalCall";
   	...
   	protected int preRenderForm(UIRenderContext context,RuntimeNormalFormInterface form) throws EpiException {
   		try{
   			...
   			AssignKey(context,keyName,KeyField,form);
   		}  catch (Exception x) {
   			x.printStackTrace();
   			return RET_CANCEL;
   		}
   	...
   	public void AssignKey(UIRenderContext context, String keyname, String KeyField, RuntimeNormalFormInterface form){
...
/*   	public TransactionServiceSORemote getTransactionServiceRemote() throws SsaException {
   		try {
