...
public class SetNavigationBasedOnFocus extends com.epiphany.shr.ui.action.ActionExtensionBase {
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException {
		...
		String bioNav = getParameterString("BioNavigation");
		String colNav = getParameterString("BioCollectionNavigation");
		if (focus.isBio()) {
			context.setNavigation(bioNav);
		} else if (focus.isBioCollection()) {
			context.setNavigation(colNav);
		}
