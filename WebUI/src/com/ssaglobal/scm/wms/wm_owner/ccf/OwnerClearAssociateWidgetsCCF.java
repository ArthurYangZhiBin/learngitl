 ...
 */
public class OwnerClearAssociateWidgetsCCF extends com.epiphany.shr.ui.action.ccf.SendAllWidgetsValuesExtensionBase
{
			...
			throws EpiException
	{
		...
		ArrayList associatedWidgets = (ArrayList) getParameter("ASSOCIATEDWIDGETS");
		
		for(Iterator it = associatedWidgets.iterator(); it.hasNext(); )
		{
