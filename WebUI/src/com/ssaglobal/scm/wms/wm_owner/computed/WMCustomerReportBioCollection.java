...
public class WMCustomerReportBioCollection implements ComputedAttributeSupport
{
	private static final String SORT_ORDER = "wm_storer_reports.rpt_id ASC";
	...
	public Object get(Bio bio, String attributeName, boolean isOldValue) throws EpiDataException
	{
		...
		try
		{
			...
			//query storer_reports
			final String orderQuery = " wm_storer_reports.consigneekey = '"+storer+"' ";
			Query storerReportQuery = new Query("wm_storer_reports", orderQuery, SORT_ORDER);
