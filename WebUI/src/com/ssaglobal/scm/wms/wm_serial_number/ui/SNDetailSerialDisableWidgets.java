...
public class SNDetailSerialDisableWidgets extends com.epiphany.shr.ui.view.customization.FormExtensionBase {
    ...
    protected int preRenderForm(ModalUIRenderContext context, RuntimeNormalFormInterface form)
       ...
       try {
    	   form.getFormWidgetByName("DATA2").setProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
    	   form.getFormWidgetByName("DATA3").setProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
    	   form.getFormWidgetByName("DATA4").setProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
    	   form.getFormWidgetByName("DATA5").setProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
    	   form.getFormWidgetByName("NETWEIGHT").setProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
