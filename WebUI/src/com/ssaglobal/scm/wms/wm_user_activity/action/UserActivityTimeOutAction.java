...
public class UserActivityTimeOutAction extends com.epiphany.shr.ui.action.ActionExtensionBase
{
	protected static ILoggerCategory _log = LoggerFactory.getInstance(UserActivityTimeOutAction.class);
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException
	{
		...
		if (login == true)
		{
			...
			/*
			 * Changing to BIO Query String activeQuery = "SELECT COUNT(*) FROM USERATTENDANCE WHERE USERID = '" +
			 * userID + "' AND STATUS = '1'"; _log.debug("LOG_DEBUG_EXTENSION", "\n\t" + activeQuery + "\n",
			...
			return RET_CONTINUE;
			//Confirm logout - Break Up Extension
			//			if(true)
			//			{
			...
			//					e.printStackTrace();
			//				}
			//				focus.setValue("DATETIMEOUT", dateFormat.format(ejbDate));
			//				//success
			//			}
			//			else
			//			{
	...
	/*
	 ...
	 focus.setValue("DATETIMEOUT", dateFormat.format(currentDateTime));
	 */
