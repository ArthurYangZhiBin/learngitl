...
public class ValidateReceiptBio extends com.epiphany.shr.data.bio.extensions.BioExtensionBase {
	protected static ILoggerCategory _log = LoggerFactory.getInstance(ValidateReceiptBio.class);
	/**
