...
public class ASNEntryCopyOwner extends com.epiphany.shr.ui.action.ActionExtensionBase {
    ...
    */
    protected int execute(ModalActionContext ctx, ActionResult args) throws EpiException {
       ...
       try {
    	   ...
    	   if(StringUtils.isEmpty(BioAttributeUtil.getString(focus, "STORERKEY"))) {
    		   RuntimeFormInterface parentForm = ASNEntryUtil.getParentForm(ctx);
    		   if(parentForm != null){
    			   String parentOwner = BioAttributeUtil.getString(parentForm.getFocus(), "STORERKEY");
    			   focus.setValue("STORERKEY", parentOwner);
        		   currentForm.getFormWidgetByName("STORERKEY").setDisplayValue(parentOwner);   
    		   }
