 ...
 * Created			:       01/Dec/2009
 * Purpose	        :       Common extension to validate STORER and CARTON 
 * 							whenever they changed in the Container Exchange 
 * 							tab of both Shipment Order and ASN Receipt
...
public class ValidateStorerForContainerXchange extends com.epiphany.shr.ui.action.ActionExtensionBase {
   ...
   protected int execute( ActionContext context, ActionResult result ) throws EpiException {
      ...
      // as appropriate
	   ...
	   if(widgetName.equalsIgnoreCase("STORERKEY"))
	   {
		   try {
		   ...
		   if (size == 0) {		    	
		    	...
		    	String[] ErrorParem = new String[2];
		 	   	...
		 	   	ErrorParem[1] = "Trading Partner";
		 	   	FieldException UsrExcp = new FieldException(FormName, WidgetName,"NotValidEntry", ErrorParem);
		 	   	throw UsrExcp; 	   
		   }
	   }
	   else if(widgetName.equalsIgnoreCase("CARTONIZATIONDESC"))
	   {		   		   
		   try {
	    	   String sQueryString = "(wm_cartonization.CARTONDESCRIPTION = '" + displayValue + "' AND wm_cartonization.CONTAINEREXCHANGEFLAG = 1)";    	   
		   ...
		   String key = listCollection.elementAt(0).get("CARTONIZATIONKEY").toString();
		   result.getFocus().setValue("CARTONIZATIONKEY", key);		   
	   }
