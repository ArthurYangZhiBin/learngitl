...
public class ReceiptSummaryRptAction extends ListSelector {
	...
	protected static ILoggerCategory _log = LoggerFactory.getInstance(ReceiptSummaryRptAction.class);
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException {
		...
		if (headerFocus instanceof BioCollection){
			...
			if(selectedItems != null && selectedItems.size() > 0)
			{
			    ...
			    paramsAndValues.put("p_ReceiptFrom",  receiptStartS);
			    ...
			    String report_url= ReportUtil.retrieveReportURL(state,"CRPT62", paramsAndValues);
...
//			context.setNavigation(DETAILVIEW);
	...
	private void callActionFromNormalForm(ActionContext context,DataBean headerFocus)throws EpiException {
		if (headerFocus instanceof BioBean){
			...
			//added to handle dates for BIRT
			...
			//DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd"); //previous Cognos version
			
			//String pStartDate = "1900-01-01"+ "%2000%3a00%3a00.000"; //previous COgnos version
