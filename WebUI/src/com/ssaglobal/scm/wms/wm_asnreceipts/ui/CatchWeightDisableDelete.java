...
public class CatchWeightDisableDelete extends com.epiphany.shr.ui.view.customization.FormExtensionBase
{
	...
	protected int preRenderForm(UIRenderContext context, RuntimeNormalFormInterface form) throws EpiException
	{
		...
		try
		{
			...
			Object status = receiptDetailFocus.getValue("STATUS");
			if (status != null && status.toString().equals("9"))
			{
				RuntimeFormWidgetInterface delWidget = form.getFormWidgetByName("DELETE");
				delWidget.setProperty(RuntimeFormWidgetInterface.PROP_READONLY, true);
			}
			else
			{
