...
public class SaveLocationId extends com.epiphany.shr.ui.action.ActionExtensionBase {


   /**
    * Saves a copy of the Bean before creating a NewBio 
   ...
   protected int execute( ActionContext context, ActionResult result ) throws EpiException {
	  ...
	  DataBean locationDataBean = detailForm.getFocus();
	  ...
	  session.setAttribute("locationDataBean",locationDataBean);
