...
public class CreatePaperCountsAction extends com.epiphany.shr.ui.action.ActionExtensionBase {

	/** The log. */
	protected static ILoggerCategory log = LoggerFactory.getInstance(CreatePaperCountsAction.class);
	...
	protected int execute(ActionContext context, ActionResult result) throws EpiException {
		...
		actionProperties.setProcedureName("NSPPAPERCYCLECOUNT");
		try {
			
			log.info("INFO", "Calling SP NSPPAPERCYCLECOUNT", SuggestedCategory.APP_EXTENSION);
