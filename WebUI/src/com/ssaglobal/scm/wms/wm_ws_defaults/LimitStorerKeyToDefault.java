...
public class LimitStorerKeyToDefault extends ActionExtensionBase{
	
	protected static ILoggerCategory _log = LoggerFactory.getInstance(LimitStorerKeyToDefault.class);
